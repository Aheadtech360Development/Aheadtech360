...
const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    image: '/images/portfolio/VIFHE.png',
    placeholder: 'VIFHE — ACCA Coaching',
    category: 'EDUCATION', location: 'PAKISTAN',
    title: 'VIFHE — ACCA Education',
    description: 'WordPress lead-gen site with batch-wise course pages, fee structure, and Meta Pixel lead capture.',
    stats: [{ value: '2x', label: 'ENROLLMENTS' }, { value: 'ACCA', label: 'NICHE' }, { value: 'PKR', label: 'MARKET' }],
    link: 'https://www.vifhe.com',
  },
  {
    platform: 'Custom', industry: 'Local Biz', workType: 'New Build', badge: 'LIVE SITE',
    image: '/images/portfolio/Effing-Gear.png',
    placeholder: 'Effing Gear — Outdoor',
    category: 'HEADWEAR', location: 'USA',
    title: 'Effing Gear',
    description: 'Custom WooCommerce + headless front-end. Hourly and geographic performance reporting built for the client\'s media team.',
    stats: [{ value: '2.99x', label: 'BLENDED ROAS' }, { value: 'USA', label: 'MARKET' }, { value: 'Custom', label: 'REPORTS' }],
    link: 'https://www.effinggear.com',
  },
]
